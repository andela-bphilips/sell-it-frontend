...
import { GET_PRODUCTS_SUCCESS, GET_PRODUCT_SUCCESS, GET_MY_PRODUCTS_SUCCESS } from '../actions/types.js';
...
export const myProducts = (state = initialState.products, action = {}) => {
  switch (action.type) {
